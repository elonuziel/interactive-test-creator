...
| `pageImage` | string | **Yes** | Relative path to the full-page scan where this question appears (e.g., `"pages_output/page_3.png"`). |
...
For **every single question**, you must set the `"pageImage"` field to point to the full page scan (e.g. `"pages_output/page_X.png"`). 
When the user views the question in the HTML quiz, they will be able to click a button and interactively crop whatever part of the full page they need directly in their browser.

**Example:**
If Question 15 appears on `pages_output/page_5.png`, just set `"pageImage": "pages_output/page_5.png"`.
